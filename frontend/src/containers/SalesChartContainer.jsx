    ...
    <div>
      {hasFutureData ? (
        ...
        <ChartDisplaySales
          ...
          title="Historical + Future Predictions (SalesAmount)"
...
SalesChartContainer.propTypes = {
  includeFutureData: PropTypes.bool,
};
SalesChartContainer.defaultProps = {
